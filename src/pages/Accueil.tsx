  ...
  return (
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div className="relative flex justify-between items-baseline" style={{ zIndex: 10 }}>
        <span style={{ ...mono, fontSize: '0.9375rem', color: encre, opacity: 0.85 }}>
          N° {num} · {annee}
        </span>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: 10 }}>
          <button
            ...
            style={{ ...mono, fontSize: '0.875rem', color: accent, opacity: 0.9, background: 'none', border: 'none', cursor: 'pointer', lineHeight: 1 }}
          >
            ✦
          </button>
          <span style={{ ...mono, fontSize: '0.9375rem', color: accent, fontWeight: 700 }}>
            {colorLabel}
          </span>
        </div>
      </div>
      ...
      {seance?.citation && (
        ...
        >
          ...
          <span style={{
            fontFamily: "'Cormorant Garamond', serif", fontSize: '1.125rem', lineHeight: 1.55,
            color: encre, display: 'block',
          }}>
            {seance.citation.t}
          </span>
          <div style={{ ...mono, fontSize: '0.875rem', fontWeight: 700, textTransform: 'uppercase', color: accent, marginTop: 5 }}>
            {seance.citation.a}
          </div>
        </motion.div>
      )}
      ...
      >
        ...
        >
          ...
          <span aria-hidden style={{ fontSize: '0.9375rem', opacity: 0.75 }}>⊕</span>
        </button>
      </motion.div>
