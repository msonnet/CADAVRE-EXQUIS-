    ...
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
        ...
        >
          ...
          <p style={{
            fontFamily: "'Cormorant Garamond', serif", fontSize: '1.125rem', color: encre, opacity: 0.85, marginBottom: 10,
          }}>
            Ta bibliothèque personnelle
          </p>
          {!chargement && (poemes.length > 0 || dessins.length > 0) && (
            <div style={{ ...mono, fontSize: '0.8125rem', color: accent, letterSpacing: '0.18em', opacity: 0.75, marginBottom: 14 }}>
        ...
        {!chargement && poemes.length > 0 && (() => {
          ...
          return (
            <AnimatePresence>
              <div>
                {termes.length > 0 && (
                  <p style={{ ...mono, fontSize: '0.875rem', color: encre, opacity: 0.75, marginBottom: 8 }}>
                    {poemesFiltres.length} RÉSULTAT{poemesFiltres.length !== 1 ? 'S' : ''}
                  </p>
                )}
                {poemesFiltres.length === 0 && (
                  <p style={{
                    fontFamily: "'Cormorant Garamond', serif", fontSize: '0.9375rem', color: encre, opacity: 0.75,
                ...
                {poemesFiltres.map((poeme, i) => (
                  ...
                  >
                    ...
                    <p style={{ ...mono, fontSize: '0.875rem', color: encre, opacity: 0.75 }}>
        ...
        {!chargement && dessins.length > 0 && (
          <motion.div
            ...
            style={{ marginTop: 16 }}
          >
            <div style={{ ...mono, fontSize: '0.875rem', color: accent, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 12, marginTop: 8 }}>
              — CADAVRES DESSINÉS —
            </div>
            {dessins.map((dessin, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <p style={{ fontFamily: "'Cormorant Garamond', serif", color: encre, fontSize: '0.9375rem', lineHeight: 1.3, marginBottom: 3, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                  ...
                  {dessin.texteVision && (
                    <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '0.875rem', color: encre, opacity: 0.85, marginTop: 3, lineHeight: 1.4 }}>
