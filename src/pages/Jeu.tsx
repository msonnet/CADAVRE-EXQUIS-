      ...
      <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom overflow-hidden">
        ...
        <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
          ...
          <div className="flex justify-between items-baseline">
            <span style={{ ...mono, fontSize: 15, color: encre, opacity: 0.7 }}>{acteLabel}</span>
          ...
          <div className="flex flex-col items-center justify-center flex-1 text-center" style={{ paddingBottom: '20%' }}>
            ...
            {iaChargement ? (
              ...
              <>
                <motion.div
                  style={{ ...mono, fontSize: 15, color: encre, opacity: 0.7, marginTop: 16, lineHeight: 1.7 }}
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 0.7 }}
          ...
          {/* Footer */}
          <div style={{ ...mono, fontSize: 15, color: encre, opacity: 0.85, textAlign: 'center', paddingBottom: 8 }}>
      ...
      <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
        ...
        <div className="flex justify-between items-baseline">
          ...
          <button
            ...
            aria-pressed={!muted}
            style={{ ...mono, fontSize: 15, color: accent, opacity: muted ? 0.35 : 0.7, background: 'none', border: 'none', cursor: 'pointer' }}
          >
            {colorLabel}
          </button>
        </div>
          ...
          >
            ...
            {contexteVisible && (
              <motion.div
                ...
                transition={{ delay: 0.2 }}
              >
                <div style={{ ...mono, fontSize: 15, color: accent, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 6 }}>
            ...
            >
              ...
              {subtitle && (
                <div style={{ ...mono, fontSize: 15, color: encre, opacity: 0.9, marginBottom: 14 }}>
                  {subtitle}
                </div>
              )}
            </motion.div>
            ...
            {modeHypnotique && tempsRestant !== null && (
              ...
              >
                ...
                <span style={{ ...mono, fontSize: 14, color: encre, opacity: 0.75 }}>s</span>
              </motion.div>
            )}
            ...
            >
              ...
              />
              {hintQuestion && (
                <p style={{ ...mono, fontSize: 15, color: encre, opacity: 0.9, marginTop: 4 }}>
            ...
            <div style={{ textAlign: 'center', paddingBottom: 4 }}>
              {!confirmAbandon ? (
                <>
                  <div style={{ ...mono, fontSize: 15, color: encre, opacity: 0.8, marginBottom: 8 }}>
                    — IRRÉVERSIBLE —
                  </div>
                  <button
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  <button
                    onClick={abandonner}
                    style={{ flex: 1, padding: '0.75em', background: '#7B0000', color: '#e8d4b8', ...mono, fontSize: 15, border: 'none', cursor: 'pointer', borderRadius: 4 }}
                  >
                    Confirmer l'abandon
                  </button>
                  <button
                    onClick={() => setConfirmAbandon(false)}
                    style={{ padding: '0.75em 1em', background: 'transparent', color: encre, ...mono, fontSize: 15, border: `0.5px solid ${encre}30`, cursor: 'pointer', borderRadius: 4 }}
                  >
                    Annuler
                  </button>
                </div>
