  ...
  return (
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
        ...
        {/* ── LABEL ── */}
        <div style={{ ...mono, fontSize: 17, color: accent, fontWeight: 700, letterSpacing: '0.22em', marginTop: 24, marginBottom: 8 }}>
          — RÉGLAGES —
        </div>
        ...
        >
          ...
          <div style={{ ...mono, fontSize: 17, color: encre, opacity: 0.6, marginTop: 8, textTransform: 'uppercase' }}>
        ...
        {/* ── VERSION ── */}
        <div style={{ ...mono, fontSize: 17, color: encre, opacity: 0.9, textAlign: 'center', paddingBottom: 8, lineHeight: 1.6 }}>
