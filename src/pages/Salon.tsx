      ...
      <PageTransition className="page-carnet flex items-center justify-center min-h-dvh">
        ...
        {roomError ? (
          <div style={{ textAlign: 'center' }}>
            <p style={{ ...mono, fontSize: 17, color: encre, opacity: 0.85 }}>{roomError}</p>
            <button onClick={() => navigate('/online')} style={{ ...mono, fontSize: 17, color: accent, background: 'none', border: 'none', cursor: 'pointer', marginTop: 16 }}>
              ← RETOUR
            </button>
          </div>
        ) : (
  ...
  return (
    <PageTransition className="page-carnet flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
        ...
        <button
          onClick={copyCode}
          style={{ ...mono, fontSize: 17, color: copied ? accent : encre, fontWeight: 700, background: 'none', border: 'none', cursor: 'pointer' }}
        >
      ...
      <div style={{ ...mono, fontSize: 17, color: accent, fontWeight: 700, letterSpacing: '0.22em', marginTop: 28, marginBottom: 4 }}>
        — SALON D'ATTENTE —
      </div>
      ...
      <div style={{ marginBottom: 24 }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ fontFamily: "'Bodoni Moda', serif", fontWeight: 700, fontSize: 17, color: encre }}>
                    ...
                    {room.host_id === p.player_id && (
                      <span style={{ ...mono, fontSize: 17, color: accent, marginLeft: 8 }}>HÔTE</span>
                    )}
                  </div>
                </div>
                <span style={{ ...mono, fontSize: 17, color: p.is_ready ? accent : `${encre}50` }}>
        ...
        {!mePlayer && (
          <div style={{
            ...mono, fontSize: 17, color: encre, opacity: 0.75,
        ...
        {!mePlayer && !spectator && (
          <button
            ...
            style={{
              ...mono, fontSize: 17, color: encre, opacity: 0.7,
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
            {spectators.map(s => (
              ...
              >
                ...
                <span style={{ ...mono, fontSize: 17, color: encre, opacity: 0.55 }}>👁 SPECT</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {isHost && (
        <div style={{ marginBottom: 24, padding: '16px', background: `${encre}06`, borderLeft: `2px solid ${accent}40` }}>
          ...
          <div style={{ marginBottom: 12 }}>
            <div style={{ ...mono, fontSize: 17, color: encre, marginBottom: 6 }}>MODE</div>
            <div style={{ display: 'flex', gap: 8 }}>
              {(['ecrit', 'dessin'] as const).map(m => (
                <button
                  ...
                  style={{
                    ...mono, fontSize: 17, padding: '6px 14px',
          ...
          {room.mode === 'ecrit' && (
            <div>
              <div style={{ ...mono, fontSize: 17, color: encre, marginBottom: 6 }}>STRUCTURE</div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                {Object.entries(STRUCT_LABELS).map(([id, label]) => (
                  <button
                    ...
                    style={{
                      ...mono, fontSize: 17, padding: '7px 14px', textAlign: 'left',
          ...
          <div style={{ marginTop: 12 }}>
            <div style={{ ...mono, fontSize: 17, color: encre, marginBottom: 6 }}>DURÉE PAR TOUR</div>
          ...
          {/* ── Visibilité du salon ── */}
          <div style={{ marginTop: 12 }}>
            <div style={{ ...mono, fontSize: 17, color: encre, marginBottom: 6 }}>VISIBILITÉ</div>
            <div style={{ display: 'flex', gap: 8 }}>
              {([
                ...
                return (
                  <button
                    ...
                    style={{
                      flex: 1, ...mono, fontSize: 17, padding: '7px 10px',
                      background: selected ? `${accent}18` : 'transparent',
                      color: selected ? accent : encre,
                      border: `1px solid ${selected ? accent : `${encre}25`}`,
                      cursor: 'pointer',
