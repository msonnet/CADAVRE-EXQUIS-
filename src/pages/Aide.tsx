  ...
  return (
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        >
          <div style={{ ...mono, fontSize: 17, color: accent, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 8 }}>
            — CADAVRE ÉCRIT —
          </div>
          <div
          ...
          {STRUCTURES.map(s => (
            <div key={s.romain} style={{ display: 'flex', gap: 14, paddingBottom: 12, borderBottom: `0.5px solid ${encre}10`, marginBottom: 12 }}>
              <span style={{ ...mono, fontSize: 17, color: accent, fontWeight: 700, minWidth: 22 }}>{s.romain}.</span>
              <div>
                <div style={{ fontFamily: "'Bodoni Moda', serif", fontWeight: 700, fontSize: 17, color: encre, marginBottom: 2 }}>
                  {s.label}
                </div>
                <div style={{ ...mono, fontSize: 17, color: encre, opacity: 0.9, marginBottom: s.exemple ? 5 : 0 }}>
                  {s.detail}
                </div>
                {s.exemple && (
          ...
          {/* Visibilité */}
          <div style={{ ...mono, fontSize: 17, color: accent, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 10, marginTop: 16 }}>
            — VISIBILITÉ —
          </div>
          {VISIBILITE.map(v => (
        ...
        <motion.div
          ...
          style={{ marginBottom: 32 }}
        >
          <div style={{ ...mono, fontSize: 17, color: second, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 8 }}>
            — CADAVRE DESSINÉ —
          </div>
          <div
            className="font-bodoni font-black leading-tight"
          ...
          {/* Raccord */}
          <div style={{ ...mono, fontSize: 17, color: second, fontWeight: 700, letterSpacing: '0.22em', marginBottom: 10 }}>
            — RACCORD —
          </div>
