    ...
    return (
      <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
        <div className="flex justify-center py-24">
          <motion.span style={{ fontSize: '1.25rem', color: accent }} animate={{ opacity: [0.3, 1, 0.3] }} transition={{ duration: 1.5, repeat: Infinity }}>✦</motion.span>
        </div>
      </PageTransition>
    )
  }
    ...
    return (
      <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
        <div style={{ position: 'relative', zIndex: 10 }}>
          <button onClick={() => navigate(-1)} style={{ ...mono, fontSize: '0.9375rem', color: encre, opacity: 0.85, background: 'none', border: 'none', cursor: 'pointer' }}>← RETOUR</button>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '0.9375rem', color: encre, opacity: 0.75, marginTop: 40, textAlign: 'center' }}>
            Dessin introuvable.
          </p>
        </div>
      </PageTransition>
    ...
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
        ...
        <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ marginBottom: 16 }}>
          {editTitre ? (
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              />
              <button onClick={sauvegarderTitre} style={{ ...mono, fontSize: '0.9375rem', color: accent, background: 'none', border: 'none', cursor: 'pointer' }}>OK</button>
              <button onClick={() => setEditTitre(false)} style={{ ...mono, fontSize: '0.9375rem', color: encre, opacity: 0.8, background: 'none', border: 'none', cursor: 'pointer' }}>✕</button>
            </div>
          ) : (
            <button
          ...
          <p style={{ ...mono, fontSize: '0.875rem', color: encre, opacity: 0.7, marginTop: 6 }}>
        ...
        >
          ...
          <div style={{ ...mono, fontSize: '0.875rem', color: encre, opacity: 0.9, marginTop: 6, textAlign: 'right' }}>
          ...
          >
            ...
            <div style={{
              ...
              {dessin.texteVision.split('\n').filter(Boolean).map((ligne, i) => (
                <p key={i} style={{
                  fontFamily: "'Cormorant Garamond', serif", fontSize: '0.9375rem', color: encre,
          ...
          {confirmSuppr ? (
            ...
            <button
              ...
              style={{
                ...
                background: 'transparent', color: encre,
                ...mono, fontSize: '0.9375rem', textTransform: 'uppercase', opacity: 0.7,
