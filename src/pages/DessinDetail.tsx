    ...
    <PageTransition className="page-carnet relative flex flex-col min-h-dvh safe-top safe-bottom">
      ...
      <div style={{ position: 'relative', zIndex: 10 }} className="flex flex-col flex-1">
        ...
        <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ marginBottom: 16 }}>
          {editTitre ? (
            <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
              ...
              />
              <button onClick={sauvegarderTitre} style={{ ...mono, fontSize: 17, color: accent, background: 'none', border: 'none', cursor: 'pointer' }}>OK</button>
              <button onClick={() => setEditTitre(false)} style={{ ...mono, fontSize: 17, color: encre, opacity: 0.8, background: 'none', border: 'none', cursor: 'pointer' }}>✕</button>
            </div>
          ) : (
            <button
          ...
          <p style={{ ...mono, fontSize: 17, color: encre, opacity: 0.7, marginTop: 6 }}>
        ...
        >
          ...
          <div style={{ ...mono, fontSize: 17, color: encre, opacity: 0.9, marginTop: 6, textAlign: 'right' }}>
