        ...
        {phase !== 'revele' && phase !== 'sauvegarde' && (
          ...
          >
            <div role="status" aria-live="polite" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 0 }}>
              ...
              <motion.div
                style={{ fontSize: '1.125rem', color: accent }}
          ...
          >
            ...
            {texteVision ? (
              <div>
                ...
                <div style={{
                  fontFamily: "'Cormorant Garamond', serif", fontSize: '0.9375rem', lineHeight: 1.7,
                  color: encre,
                  whiteSpace: 'pre-line',
                }}>
                  {texteVision}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '0.875rem', color: encre, opacity: 0.8 }}>
              ...
              <div style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: '0.9375rem', color: encre, opacity: 0.75 }}>
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                color: '#e8d4b8',
                ...mono, fontSize: '0.9375rem', padding: '6px 12px',
                cursor: 'pointer',
              }}
            >
              ✕ FERMER
